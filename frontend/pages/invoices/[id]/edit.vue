  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
    <div class="max-w-3xl mx-auto px-6 sm:px-8 lg:px-10">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-gray-600 mt-1">Update the invoice details below</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-if="loading" class="bg-white rounded-xl shadow-lg p-12 text-center">
        ...
        <p class="text-gray-600 text-lg font-medium">Loading invoice details...</p>
      </div>

      <!-- Form Section -->
      <form v-else @submit.prevent="handleSubmit" class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6 bg-gray-50 flex flex-col sm:flex-row justify-end gap-4">
          ...
          >
            ...
            <span v-if="submitting">Updating Invoice...</span>
...
const fetchInvoice = async () => {
  try {
    ...
    const invoice = await $fetch(`${config.public.apiBase}/invoices/${invoiceId}/`, {
      headers: {
...
const handleSubmit = async () => {
  ...
  try {
    await $fetch(`${config.public.apiBase}/invoices/${invoiceId}/`, {
      method: 'PUT',
      headers: {
        Authorization: `Bearer ${authStore.token}`
      },
    ...
    error.value = err.data?.detail || 'Failed to update invoice. Please try again.'
    console.error(err)
  } finally {
